...
$sql = "SELECT * FROM temp_class WHERE locations LIKE '%$location%' ORDER BY names"; 
if($res = mysqli_query($link, $sql)){ 
	if(mysqli_num_rows($res) > 0){ 
      ...
      echo "<td>" . $row['names'] . "<br>" . $row['locations'] . "<br>" . $row['prices'] . "<br>" . $row['details'] . "<br>" .$row['booklinks']. "</td>"; 
			echo "</tr>"; 
		} 
		echo "</table>"; 
